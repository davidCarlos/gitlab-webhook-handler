...
from .__version__ import __package__, __version__
from gwh import app
import gwh

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog="python -m gwh", description="GitLab webhook handler"
    )
    ...
    try:
        ...
        print(
            "Error opening repos file %s -- check file exists and is valid JSON"
            % args.config
        )
        raise
